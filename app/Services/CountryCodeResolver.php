...
class CountryCodeResolver
{
    ...
    public array $timezoneCountryCodeMap = [
        'Africa/Abidjan' => 'CI',
        'Africa/Accra' => 'GH',
    ...
    public function resolveFromTimeZone(string $timezone): string
    {
        $countryCode = $this->timezoneCountryCodeMap[$timezone] ?? '';

        if (! $countryCode) {
            info("Could not resolve country code for time zone: $timezone");
        }
